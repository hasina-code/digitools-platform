  ...
  return (
    <section className="py-24 px-6 bg-[#F9FAFB]">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-black text-[#101727] mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {stepsData.map((step) => (
            <div 
              key={step.id} 
              className="relative p-10 bg-white border border-gray-100 rounded-[40px] shadow-sm hover:shadow-xl transition-all duration-300 group"
            >
              {/* Step Number Badge */}
              ...
              {/* Icon Container */}
              <div className="w-24 h-24 bg-[#F5F3FF] rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform duration-300">
                <img 
                  src={step.icon} 
